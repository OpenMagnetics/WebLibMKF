...
namespace MAS {
    ...
    class LlcResonant {
         ...
         */
        const double & get_inductance_ratio() const { return inductance_ratio; }
        double & get_mutable_inductance_ratio() { return inductance_ratio; }
        void set_inductance_ratio(const double & value) { this->inductance_ratio = value; }
     ...
     */
    enum class Topologies : int { ACTIVE_CLAMP_FORWARD_CONVERTER, BOOST_CONVERTER, BUCK_CONVERTER, CLLC_RESONANT_CONVERTER, CUK_CONVERTER, CURRENT_TRANSFORMER, DUAL_ACTIVE_BRIDGE_CONVERTER, FLYBACK_CONVERTER, FULL_BRIDGE_CONVERTER, HALF_BRIDGE_CONVERTER, INVERTING_BUCK_BOOST_CONVERTER, ISOLATED_BUCK_BOOST_CONVERTER, ISOLATED_BUCK_CONVERTER, LLC_RESONANT_CONVERTER, PHASE_SHIFTED_FULL_BRIDGE_CONVERTER, PUSH_PULL_CONVERTER, SEPIC, SINGLE_SWITCH_FORWARD_CONVERTER, TWO_SWITCH_FORWARD_CONVERTER, WEINBERG_CONVERTER, ZETA_CONVERTER };
...
namespace MAS {
    ...
    inline void from_json(const json & j, LlcResonant& x) {
        ...
        x.set_efficiency(get_stack_optional<double>(j, "efficiency"));
        x.set_inductance_ratio(j.at("inductanceRatio").get<double>());
        x.set_input_voltage(j.at("inputVoltage").get<DimensionWithTolerance>());
