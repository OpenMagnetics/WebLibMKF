...
#
get_filename_component(filename "/home/alf/OpenMagnetics/WebLibMKF/build/_deps/ngspice/src/ngspice-45.2.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/alf/OpenMagnetics/WebLibMKF/build/_deps/ngspice/src/ngspice_external" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-ngspice_external${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-ngspice_external${i}")
